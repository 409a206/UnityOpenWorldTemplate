...
//[RequireComponent(typeof(GunController))] //이게 있으면 theGunController의 값이 요구됨, 값을 뺄 수가 없어짐. 실수 방지용.
public class WeaponManager : MonoBehaviour
{

    //static 선언을 하면 공유자원이 됨. 클래스 변수 = 정적 변수.
    //무기 중복 교체 실행 방지
    ...
    //    Debug.Log( gunDictionary["AK47"];); //이런식으로 key, value를 사용하면 됨
